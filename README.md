# L2HFuelNet: A deep learning framework for weakly supervised large-scale wildfire fuel mapping from multi-source remote sensing data
...
```bibtex
@article{paper,
  title={L2HFuelNet: A deep learning framework for weakly supervised large-scale wildfire fuel mapping from multi-source remote sensing data},
